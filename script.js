...
function displayPrediction(colourStats, dozenStats) {
    ...
    if (bestDozen === "2nd") dozenNumbers = Array.from({length:12},(_,i)=>i+13);
    if (bestDozen === "3rd") dozenNumbers = Array.from({length:12},(_,i)=>i+25);

    // Step 2: Colour filter
